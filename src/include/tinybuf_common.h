...
int tinybuf_try_read_box_with_mode(buf_ref *buf, tinybuf_value *out, CONTAIN_HANDLER contain_handler, tinybuf_read_pointer_mode mode, tinybuf_result *r);
int tinybuf_try_read_box(buf_ref *buf, tinybuf_value *out, CONTAIN_HANDLER contain_handler, tinybuf_result *r);
int tinybuf_try_write_box(buffer *out, const tinybuf_value *value, tinybuf_result *r);
int tinybuf_try_read_box_with_plugins(buf_ref *buf, tinybuf_value *out, CONTAIN_HANDLER contain_handler, tinybuf_result *r);
...
int tinybuf_custom_try_read(const char *name, const uint8_t *data, int len, tinybuf_value *out, CONTAIN_HANDLER contain_handler, tinybuf_result *r);
int tinybuf_custom_try_write(const char *name, const tinybuf_value *in, buffer *out, tinybuf_result *r);
int tinybuf_custom_try_dump(const char *name, buf_ref *buf, buffer *out, tinybuf_result *r);

int tinybuf_try_write_version_box(buffer *out, uint64_t version, const tinybuf_value *box, tinybuf_result *r);
int tinybuf_try_write_version_list(buffer *out, const uint64_t *versions, const tinybuf_value **boxes, int count, tinybuf_result *r);
int tinybuf_try_write_plugin_map_table(buffer *out, tinybuf_result *r);

int tinybuf_try_write_part(buffer *out, const tinybuf_value *value, tinybuf_result *r);
int tinybuf_try_write_partitions(buffer *out, const tinybuf_value *mainbox, const tinybuf_value **subs, int count, tinybuf_result *r);

int tinybuf_try_write_pointer(buffer *out, int t, int64_t offset, tinybuf_result *r);
int tinybuf_try_write_sub_ref(buffer *out, int t, int64_t offset, tinybuf_result *r);
int tinybuf_try_write_custom_id_box(buffer *out, const char *name, const tinybuf_value *in, tinybuf_result *r);
