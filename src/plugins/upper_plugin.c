...
__declspec(dllexport) tinybuf_plugin_descriptor* tinybuf_get_plugin_descriptor(void){ static uint8_t types[1] = { DLL_UPPER_TYPE }; static tinybuf_plugin_descriptor d = { types, 1, dll_upper_read, dll_upper_write, dll_upper_dump, dll_upper_show_value }; return &d; }
